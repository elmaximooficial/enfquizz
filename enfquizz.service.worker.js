...
/** @type {string} */
const CACHE_VERSION = '1751394218|41227648';
/** @type {string} */
const CACHE_PREFIX = 'enfquizz-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'enfquizz.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["enfquizz.html","enfquizz.js","enfquizz.offline.html","enfquizz.icon.png","enfquizz.apple-touch-icon.png","enfquizz.audio.worklet.js","enfquizz.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["enfquizz.wasm","enfquizz.pck"];
